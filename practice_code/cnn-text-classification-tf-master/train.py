...
# Misc Parameters
# TODO : don't know well this option
tf.flags.DEFINE_boolean("allow_soft_placement", True, "Allow device soft device placement")
tf.flags.DEFINE_boolean("log_device_placement", False, "Log placement of ops on devices")

# code interpret #
FLAGS = tf.flags.FLAGS  # Make flag object
...
# code interpret #
# set sentence length in vocab_processor
...
# code interpret #
# dev set : adjust training algorithm parameter and prevent overfitting

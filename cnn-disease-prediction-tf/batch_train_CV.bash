...
./train.py --window_height=2 --out_subdir="refined_data/0/" --num_nodes="0" --filter_sizes="1,2"
./train.py --window_height=2 --out_subdir="refined_data/0/" --num_nodes="0" --filter_sizes="1,2"
./mean_RMSE.py "../../result_disease_cnn/refined_data/0/"


./train.py --window_height=2 --out_subdir="refined_data/280/" --num_nodes="280" --filter_sizes="1,2"
./train.py --window_height=2 --out_subdir="refined_data/280/" --num_nodes="280" --filter_sizes="1,2"
./mean_RMSE.py "../../result_disease_cnn/refined_data/280/"
